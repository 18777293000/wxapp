...
Page({
    ...
    getPrice: function() {
        var t = this, e = t.data.total_price, a = t.data.express_price, i = t.data.picker_coupon, o = t.data.integral, s = t.data.integral_radio, n = t.data.level, r = t.data.offline;
        i && (e -= i.sub_price), o && 1 == s && (e -= parseFloat(o.forehead)), n && (e = e * n.discount / 10), 
        e <= .01 && (e = .01), 0 == r && (e += a), t.setData({
            new_total_price: parseFloat(e.toFixed(2))
        });
    },
    cardDel: function() {
        this.setData({

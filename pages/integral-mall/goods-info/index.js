var WxParse = require("../../../wxParse/wxParse.js"), gSpecificationsModel = require("../../../components/goods/specifications_model.js"), goodsBanner = require("../../../components/goods/goods_banner.js");
        ...
        getApp().core.showLoading({
            ...
            success: function(t) {
                if (0 == t.code) {
                    ...
                    var e = t.data.goods;
                    e.num = t.data.goods.goods_num, e.pic_list = t.data.goods.goods_pic_list, o.setData({
                        goods: t.data.goods,
